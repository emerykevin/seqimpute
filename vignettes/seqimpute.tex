...
\includegraphics[width=.7\textwidth]{figure/fig_mvad-seqdplot-1} \end{Schunk}
...
\includegraphics[width=.7\textwidth]{figure/fig_cca-seqdplot-1} \end{Schunk}
...
\includegraphics[width=.7\textwidth]{figure/fig_miss-seqdplot-1} \end{Schunk}
...
\includegraphics[width=.7\textwidth]{figure/fig_seqmissIplot-1} \end{Schunk}
...
\includegraphics[width=.7\textwidth]{figure/fig_seqmissIplot-fromend-1} \end{Schunk}
...
\includegraphics[width=.7\textwidth]{figure/fig_seqmissfplot-1} \end{Schunk}
...
\includegraphics[width=.7\textwidth]{figure/fig_seqmissfplot-nocomplete-1} \end{Schunk}
...
\includegraphics[width=.99\textwidth]{figure/fig_seqmissimplic-plot-1} \end{Schunk}
...
\includegraphics[width=.65\textwidth]{figure/fig_cqi-plot-1} \end{Schunk}
			\caption{States that better characterise, at each time point, sequences with at least one missing value (left) and sequences with no missing data (right).}
			\label{fg_cqi-plot}
		\end{center}
	\end{figure}
...
\includegraphics[width=.85\textwidth]{figure/fig_clusters-plot-1} \end{Schunk}
